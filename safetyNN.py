...
if __name__ == '__main__':
    ...
    #Enviroment Model
    Env_weights1 = tf.Variable(tf.random_uniform([6, E1], .1, 1.0)
    ...
    Env_bias3 = tf.Variable(tf.random_uniform([4], .1, 1.0))
    
    #Envirment Model Map
    states_with_action = tf.placeholder(tf.float32, [None, 6], name="states_with_actions")  
    ...
    next_states_guess = tf.matmul(Env_hidden_3, Env_weights4) + Env_bias3
    ...
    with tf.Session() as sess:
        ...
        for episode in xrange(max_episodes):
            ...
            for step in xrange(max_steps):
                ...
                observedTuple = env.step(action)
                new_state, reward, done, _ = observedTuple[1]
                reward_sum += reward
                ...
                if True:
                    ...
                    sess.run(Env_train, feed_dict={states: states_samples, next_states: next_states_samples})
